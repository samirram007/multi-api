...
namespace Modules\Aipt\StockJournalStorageUnitEntry\Models;

use Modules\Aipt\StockItem\Models\StockItem;
use Modules\Aipt\StockJournalEntry\Models\StockJournalEntry;
use Modules\Aipt\StockJournalStorageUnitEntryPurge\Models\StockJournalStorageUnitEntryPurge;
...
class StockJournalStorageUnitEntry extends Model
{
    ...
    public function stock_item(): mixed
    {
        return $this->hasOneThrough(
            ...
            'id',               // StockItem.id
            'stock_journal_entry_id', // StockJournalStorageUnitEntry.stock_journal_entry_id
