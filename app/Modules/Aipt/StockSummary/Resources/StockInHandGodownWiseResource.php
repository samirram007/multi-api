...
namespace Modules\Aipt\StockSummary\Resources;
...
class StockInHandStorageUnitWiseResource extends SuccessResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            'storage_unitId' => $this['storage_unit_id'],
            'storage_unitName' => $this['storage_unit_name'],
            'storage_unitCode' => $this['storage_unit_code'],
            ...
            'itemDetails' => StockInHandItemWiseResource::collection($this['item_details'] ?? []),
