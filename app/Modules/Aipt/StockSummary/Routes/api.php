...
use Modules\Aipt\StockSummary\Controllers\Api\StockSummaryController;
...
Route::group(['middleware' => ['jwt.cookies']], function () {
    ...
    Route::get('/stock_summaries/stock_in_hand_storage_unit_wise', [StockSummaryController::class, 'stock_in_hand_storage_unit_wise']);
