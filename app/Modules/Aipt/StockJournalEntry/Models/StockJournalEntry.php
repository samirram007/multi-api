...
namespace Modules\Aipt\StockJournalEntry\Models;

use App\Enums\MovementType;
use Modules\Aipt\StockItem\Models\StockItem;
use Modules\Aipt\StockJournal\Models\StockJournal;
use Modules\Aipt\StockJournalEntryPurge\Models\StockJournalEntryPurge;
...
//         });
    ...
    public function stock_journal_storage_unit_entries(): HasMany
    {
        return $this->hasMany(StockJournalStorageUnitEntry::class, 'stock_journal_entry_id');
    }
