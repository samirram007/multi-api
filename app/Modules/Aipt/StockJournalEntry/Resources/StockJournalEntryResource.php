...
namespace Modules\Aipt\StockJournalEntry\Resources;

use Modules\Aipt\StockItem\Resources\StockItemResource;
use Modules\Aipt\StockJournal\Resources\StockJournalResource;
use Modules\Aipt\StockJournalStorageUnitEntry\Resources\StockJournalStorageUnitEntryResource;
use Modules\Aipt\StockUnit\Resources\StockUnitResource;
...
class StockJournalEntryResource extends SuccessResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'stockJournalStorageUnitEntries' => StockJournalStorageUnitEntryResource::collection($this->whenLoaded('stock_journal_storage_unit_entries')),
